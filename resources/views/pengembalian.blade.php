            ...
            <table class="table align-items-center">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" class="sort" data-sort="daftar">Tanggal Kembali</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody class="list">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a type="button" href="{{route('pengembalian-buku', $daftars->id)}}" class="btn btn-sm btn-primary text-white px-3">Lihat</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div class="card-header">
    <div class="row align-items-center">
        ...
        <div class="col-4 text-right">
            <a type="button" href="{{route('pengembalian')}}" class="btn btn-sm btn-danger text-white">Kembali</a>
        </div>
    </div>
</div>
<div class="card-body">
